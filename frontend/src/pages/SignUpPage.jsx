      ...
      <div className="w-full max-w-md bg-white rounded-3xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 font-medium mt-2">
            Join to start tracking your expenses
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-4 text-white font-bold text-base w-full rounded-xl px-4 py-4 bg-violet-600 hover:bg-violet-700 shadow-lg shadow-violet-600/30 transition-all duration-300 transform hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none"
          >
